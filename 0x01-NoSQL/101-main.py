...
top_students = __import__('101-top_students').top_students
...
if __name__ == "__main__":
    ...
    for j_student in j_students:
        insert_school(school_collection, **j_student)

    students = list_all(student_collection)
    for student in students:
        print("[{}] {} - {}".format(student.get('_id'), student.get('name'), student.get('topics')))

    top_students = top_students(school_collection)
